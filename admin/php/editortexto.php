	...
	<div class="" id="divGeral" style="width: 100%;">
		...
		<form onsubmit="atualizaTextArea()" action="editortexto.php?mapfile=<?php echo $_GET["mapfile"];?>" method=post>
			<fieldset style="position: relative; float: left; width: 48%; padding: 5px;">
				...
				<input type=submit value="Salvar" /> <input type=button value="Testar" onclick="testar()" /> <input type=button value="Testar no i3Geo" onclick="abrirI3geo()" /> <input type=button value="Tabela" onclick="abrirTabela()" /> (Salve antes de testar) Mais detalhes sobre a edi&ccedil;&atilde;o de
				mapfiles: <a href="http://mapserver.org/mapfile/index.html#mapfile" target="_new">Documenta&ccedil;&atilde;o do Mapserver</a> <br> <br>
			...
			?>
				...
				Ctrl-z - Desfazer<br>
				Ctrl-Up - Sobe<br>
				Alt-left - In&iacute;cio da linha</p>
			</fieldset>
