...
i3GEOF.converteKml = {
	...
	*/
	iniciaJanelaFlutuante: function(tema,tipo){
		...
		titulo = "<div class='i3GeoTituloJanela'>Kml<a class=ajuda_usuario target=_blank href='" + i3GEO.configura.locaplic + "/ajuda_usuario.php?idcategoria=5&idajuda=81' ><b> </b></a></div>";
