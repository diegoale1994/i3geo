...
$titulo = $_GET['titulo'];
$logoestado = $_GET['logovol']; //agregamos
...
$pdf->Rect(3, 3, $nW+69, 14, 'D');//T&iacute;tulo nw+69 ori
...
//$pdf->Image("../../imagens/rosa.jpg", 280, 5, 10); //agregamos
...
//$pdf->Image("../../imagens/rosa.jpg", 23, $nH+20, 25); //agregamos

if ($logoestado=="Yes"){
$pdf->Image("../../imagens/i3geo1.jpg", 23, $nH+5, 25);
$pdf->Image("../../imagens/rosa.jpg", 280, 5, 10); //agregamos funciona ok
$pdf->Image("../../imagens/colombia.jpg", 267, 22, 25); //para mapa de Colombia
