...
i3GEOF.pontoEmPoligono = {
	...
	*/
	iniciaJanelaFlutuante: function(){
		...
		titulo = "<div class='i3GeoTituloJanela'>" + $trad("u13")+"<a class=ajuda_usuario target=_blank href='" + i3GEO.configura.locaplic + "/ajuda_usuario.php?idcategoria=3&idajuda=18' ><b> </b></a></div>";
		cabecalho = function(){};
		minimiza = function(){
