...
i3GEOF.perfil = {
	...
	*/
	iniciaJanelaFlutuante: function(pontos){
		...
		titulo = "<div class='i3GeoTituloJanela'>" + $trad("x54")+"<a class=ajuda_usuario target=_blank href='" + i3GEO.configura.locaplic + "/ajuda_usuario.php?idcategoria=3&idajuda=96' ><b> </b></a></div>";
		cabecalho = function(){};
		minimiza = function(){
